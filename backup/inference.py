    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for i in range(0, self.numGhosts):
                oldDistribution = setGhostPositions(gameState, list(oldParticle))
                newParticle[i] = util.sample(getPositionDistributionForGhost(oldDistribution, i, self.ghostAgents[i]))
